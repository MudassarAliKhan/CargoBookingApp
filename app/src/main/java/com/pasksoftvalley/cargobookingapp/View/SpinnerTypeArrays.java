...
public class SpinnerTypeArrays {
    ...
    public static final String[] caseTypes = {"Murder","Threats","Harassment"};

    public static String getCountryFromCountryCode(String code)
    {
        String countryName="";
        for(int i=0;i<countryAreaCodes.length;i++)
        {
            if(code.equals(countryAreaCodes[i]))
            {
    ...
    public static String getCodeFromCountryName(String name)
    {
        ...
        {
            if(name.equals(countryNames[i]))
            {
                countryCode=countryAreaCodes[i];
            }
        }
        return countryCode;
    }
